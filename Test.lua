if (game:GetService("CoreGui")):FindFirstChild("ZVIO") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).ZVIO:Destroy();
...
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("ZVIO")).Enabled = not (game.CoreGui:FindFirstChild("ZVIO")).Enabled;
end);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("ZVIO") then
			makefolder("ZVIO");
		end;
		if not isfolder("ZVIO/Library/") then
			makefolder("ZVIO/Library/");
		end;
		if not isfile(("ZVIO/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("ZVIO/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("ZVIO/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("ZVIO/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("ZVIO/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local ZVIO = Instance.new("ScreenGui");
	ZVIO.Name = "ZVIO";
	ZVIO.Parent = game.CoreGui;
	ZVIO.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = ZVIO;
